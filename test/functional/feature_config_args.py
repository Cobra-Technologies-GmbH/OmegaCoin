...
class ConfArgsTest(OmegacoinTestFramework):
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "omegacoin.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.omegacoin)
