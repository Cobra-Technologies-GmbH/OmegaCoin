...
from test_framework.omegacoin_node import OmegacoinTestNode
...
class OMEGACOIN_ColdStakingTest(OmegacoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(OmegacoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 OMEGA from the pot)
...
if __name__ == '__main__':
    OMEGACOIN_ColdStakingTest().main()
