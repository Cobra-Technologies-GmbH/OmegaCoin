...
class FullBlockTest(OmegacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure omegacoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure omegacoind isn't accepting b28
        ...
        # OMEGACOIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the omegacoin code has custom code which does so);
