...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the OmegacoinTestFramwork, place overrides for the
...
with the omegacoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a omegacoind.  `P2PInterface`
...
Basic code to support P2P connectivity to a omegacoind.
