...
"""Verify that starting omegacoin with -h works as expected."""
import subprocess

from test_framework.test_framework import OmegacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OmegacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start omegacoin with -? for help text")
        ...
        self.log.info("Start omegacoin with -version for version information")
