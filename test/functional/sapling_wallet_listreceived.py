...
class ListReceivedTest (OmegacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 OMEGA.
        ...
        # Send 1 OMEGA to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 OMEGA sending them all (fee is 0.1 OMEGA)
        ...
        # Confirm transaction (2 OMEGA from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 OMEGA, send 0.6 OMEGA + 0.05 OMEGA fee
