...
class WalletTest(OmegacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 OMEGA from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 OMEGA
        # - 7 coins of 250.00 OMEGA
        # - 1 coin of 228.9999xxxx OMEGA
