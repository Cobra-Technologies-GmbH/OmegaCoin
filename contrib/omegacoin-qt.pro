...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/omegacoin-cli.cpp \
           src/omegacoin-tx.cpp \
           src/omegacoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/omegacoin.qrc src/qt/omegacoin_locale.qrc

TRANSLATIONS += src/qt/locale/omegacoin_bg.ts \
                src/qt/locale/omegacoin_de.ts \
                src/qt/locale/omegacoin_en.ts \
                src/qt/locale/omegacoin_es.ts \
                src/qt/locale/omegacoin_fi.ts \
                src/qt/locale/omegacoin_fr.ts \
                src/qt/locale/omegacoin_it.ts \
                src/qt/locale/omegacoin_ja.ts \
                src/qt/locale/omegacoin_pl.ts \
                src/qt/locale/omegacoin_pt.ts \
                src/qt/locale/omegacoin_ru.ts \
                src/qt/locale/omegacoin_sk.ts \
                src/qt/locale/omegacoin_sv.ts \
                src/qt/locale/omegacoin_vi.ts \
                src/qt/locale/omegacoin_zh_CN.ts \
                src/qt/locale/omegacoin_zh_TW.ts
