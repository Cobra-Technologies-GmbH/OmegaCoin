OMEGACOIN Core version v5.1.0 is now available from:  <https://github.com/Cobra-Technologies-GmbH/OmegaCoin/releases>
...
- #2249 Make box of OMEGACOIN Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better omegacoin.conf Masternode data error notification (furszy)
