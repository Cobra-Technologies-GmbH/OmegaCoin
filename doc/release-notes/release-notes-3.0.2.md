...
Users that wish to prevent this behavior (not recommended) can pass `-backupzomega=0` at the command-line when starting the client, or add `backupzomega=0` to their `pivx.conf` file.
