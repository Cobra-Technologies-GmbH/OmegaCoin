...
memory available when compiling OMEGACOIN Core. On systems with less, gcc can be
...
To build OMEGACOIN Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your OMEGACOIN Core installation more secure by making certain attacks impossible to
