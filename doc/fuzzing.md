...
To build OMEGACOIN Core using AFL instrumentation (this assumes that the
...
with certain assembly code from OMEGACOIN Core's code. See [developer notes on sanitizers](https://github.com/Cobra-Technologies-GmbH/OmegaCoin/blob/master/doc/developer-notes.md#sanitizers)
