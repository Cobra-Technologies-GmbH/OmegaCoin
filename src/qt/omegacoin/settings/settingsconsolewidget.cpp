...
#include "qt/omegacoin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(OMEGACOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the OMEGACOIN RPC console.") + "<br>" +
