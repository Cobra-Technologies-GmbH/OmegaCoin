...
#include "qt/omegacoin/forms/ui_coldstakingwidget.h"
#include "qt/omegacoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/omegacoin/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(OMEGACOINGUI* parent) :
    PWidget(parent),
