...
#include "qt/omegacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(OMEGACOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &OMEGACOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
