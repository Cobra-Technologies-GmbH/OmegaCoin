...
// Render OMEGACOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZOmega = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZOmega = false);
