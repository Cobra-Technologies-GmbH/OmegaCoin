...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            OMEGACOINGUI* window = static_cast<OMEGACOINGUI*>(parentWidget());
...
{
    OMEGACOINGUI* gui = static_cast<OMEGACOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<OMEGACOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("OMEGACOIN will close now to finish the encryption process. "
